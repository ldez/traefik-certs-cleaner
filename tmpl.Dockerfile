...
WORKDIR /go/src/github.com/ldez/traefik-certs-cleaner
...
COPY --from=builder /go/src/github.com/ldez/traefik-certs-cleaner/traefik-certs-cleaner /usr/bin/traefik-certs-cleaner
